...
public class UnitMotor extends Unit
{
			...
			String MinPos, String MaxPos)
	{
		...
		setMinWidth(maxToZeroOrOriginal(HelperFunctions.StringToDouble(MinWidth)));
		setMaxWidth(maxToZeroOrOriginal(HelperFunctions.StringToDouble(MaxWidth)));
		setMinHeight(maxToZeroOrOriginal(HelperFunctions.StringToDouble(MinHeight)));
		setMaxHeight(maxToZeroOrOriginal(HelperFunctions.StringToDouble(MaxHeight)));
