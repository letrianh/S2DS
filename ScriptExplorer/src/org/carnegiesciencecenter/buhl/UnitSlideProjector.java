...
public class UnitSlideProjector extends Unit
{
	...
	{
		super(Name, SLIDE_PROJ);
		azimuth 	= maxToZeroOrOriginal(HelperFunctions.StringToDouble(Azimuth));
		elevation 	= maxToZeroOrOriginal(HelperFunctions.StringToDouble(Elevation));
		rotation 	= maxToZeroOrOriginal(HelperFunctions.StringToDouble(Rotation));
		width 		= maxToZeroOrOriginal(HelperFunctions.StringToDouble(Width));
		height 		= maxToZeroOrOriginal(HelperFunctions.StringToDouble(Height));
	}
